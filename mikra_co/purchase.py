...
class purchase_order(osv.Model):
    ...
    SORT_VRSTE = (('name_az','Po nazivu (A->Z)'),
                  ...
                  ('price_h','Po jediničnoj cijeni - od veće'),
                  ('price_l','Po jediničnoj cijeni - od manje'))
                     
    _columns = {
                'sort_print':fields.selection(SORT_VRSTE,'Redosljed stavaka pri ispisu',
                                              help="Ostaviti prazno za ispis po redosljedu unosa ili izabrati željeni redosljed")
                }
